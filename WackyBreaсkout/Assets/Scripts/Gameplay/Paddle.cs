...
public class Paddle : MonoBehaviour
{
	...
	void Start()
	{
        ...
        freezeTimer.AddTimerFinishedListener(HandleFreezerTimerFinished);
        EventManager.AddFreezerEffectListener(HandleFreezerEffectActivated);
    }
    ...
    private void HandleFreezerEffectActivated(float duration)
    {
        isFrozen = true;
        if (freezeTimer.Running == false)
        {
    ...
    private void HandleFreezerTimerFinished()
    {
